...
生成时间：2026-08-14T04:05:21.830431+08:00
...
| 外部密钥与共享票据状态 | completed_ha_test_environment | OpenBao Transit+KV 7/7；三节点Raft故障切换 8/8 | 本机三进程已验证HA；正式生产仍需跨故障域、TLS、自动解封、备份恢复和容量压测 |
