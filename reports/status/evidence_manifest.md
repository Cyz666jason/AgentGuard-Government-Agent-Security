...
生成时间：`2026-08-28T05:57:20+08:00`（中国标准时间）
测试源提交：`1df5102`；source tree hash：`dc914431ff6c6b123c9ef2f80354b62b38cf2e40`
测试开始时工作树干净：`True`；清单生成时工作树干净：`False`

## 环境

- OS：`Windows-10-10.0.26100-SP0`
- Python：`Python 3.8.6`；OPA：`Version: 1.19.0`；Node：`v24.19.0`；pnpm：`11.19.0`；OpenClaw：`OpenClaw 2026.7.1-2 (0790d9f)`
...
| 检查 | 退出码 | 结果 | 执行时间 | 证据 |
|---|---:|---|---|---|
| OPA核心策略测试 | 0 | passed | 2026-08-28T05:50:59+08:00 | `reports/core/full_opa_tests.txt` |
| OPA-Envoy部署策略测试 | 0 | passed | 2026-08-28T05:50:59+08:00 | `reports/e2e/network/opa_envoy_policy_tests.txt` |
| Python全量安全回归 | 0 | passed | 2026-08-28T05:54:36+08:00 | `reports/core/full_python_tests.txt` |
| OPA核心55例评测 | 0 | passed | 2026-08-28T05:48:59+08:00 | `reports/core/evaluation_results.csv`；`reports/core/evaluation_summary.json`；`reports/core/evaluation_report.md` |
| 阶段4只读预检 | 2 | blocked_external_environment | 2026-08-28T05:49:10+08:00 | `reports/preflight/stage4_preflight.json`；`reports/preflight/stage4_preflight.md` |
| 发布前敏感信息扫描 | 0 | passed | 2026-08-28T05:56:48.481897+08:00 | `reports/status/prepublish_security_check.json` |
| 状态一致性检查 | 0 | passed | 2026-08-28T05:57:13+08:00 | `reports/status/status_consistency_check.json` |
...
| OpenClaw远程MCP双用户HTTP E2E | 0 | passed | 2026-08-27T21:49:20.708080+00:00 | `reports/e2e/openclaw/openclaw_remote_mcp_e2e.json`；`reports/e2e/openclaw/openclaw_remote_mcp_e2e.md` |
...
| remote_mcp_e2e_report | `reports/e2e/openclaw/openclaw_remote_mcp_e2e.json` | `122fa06c5195aa60789c8b744afc8e42bce7dd380d04c9eb8922c69c5fbd9533` |
| remote_mcp_e2e_summary | `reports/e2e/openclaw/openclaw_remote_mcp_e2e.md` | `584ea991d0a9401b4c224bb8d71711fc7dc5349c3dae31d2460f667d637c8f5a` |
| evaluation_report | `reports/core/evaluation_summary.json` | `2d534965d62f8d36bb98e1f15ae417d09b62337b1928ee167e832f374c757497` |
| test_log | `reports/core/full_python_tests.txt` | `35d18505580fd856984c0edbc25e144e752cc097d0a575f76ba1e46157055f84` |
| test_log | `reports/core/full_opa_tests.txt` | `9360935d8c7a0ddb80986ebb35f172c7a4030d3929e72ec797db3f37567dd348` |
