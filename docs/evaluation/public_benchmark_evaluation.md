...
python scripts/run_public_benchmark_evaluation.py evaluate `
  ...
  --output reports\evaluation\public-benchmarks\public_benchmark_injecagent_evaluation.json
```
...
- `reports/evaluation/public-benchmarks/public_benchmark_agentdojo_fixture.json`
- `reports/evaluation/public-benchmarks/public_benchmark_injecagent_fixture.json`
- `reports/evaluation/public-benchmarks/public_benchmark_agentharm_fixture.json`
- `reports/evaluation/public-benchmarks/public_benchmark_fixture_smoke.json`
