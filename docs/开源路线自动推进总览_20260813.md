...
| Python安全测试 | 173/173 | 身份、审批、网关、适配器、OpenClaw MCP、容器后端票据校验、内核、公开基准适配与阶段4预检回归通过 | 不等于外部生产系统E2E |
...
- 单项复测 Keycloak 7/7；随后完整一键回归通过，加入公开基准、阶段4对抗门禁和 OpenClaw MCP 适配器后 Python 测试增至173。
...
| B 当前原型 | 完整一键回归 | 已完成 | 31/31、55/55、173/173、网络5/5、身份7/7、OpenBao10/10、Raft HA 8/8、QEMU11/11、OpenClaw接入9/9、综合检查23/23 | 每次变更自动回归并保留时间戳 |
